...
let
    ...
    src_haxe_swflib = {
      ...
      src = (fetchurl { url = "http://mawercer.de/~nix/reposhaxe_swflib-cvs-F_14-39-27.tar.bz2"; sha256 = "4807ff68044330f5eb512715008fcba955b5bdfcc3b3b13a38f43c1ce599272a"; });
    ...
    src_haxe_extc = { 
      ...
      src = (fetchurl { url = "http://mawercer.de/~nix/reposhaxe_extc-cvs-F_14-42-13.tar.bz2"; sha256 = "8c78c3cdbf25639c34d82a6bb8427df96dab895864fcf1ccfa247c29f6eb001f"; });
    ...
    src_haxe_extlib_dev = { 
      ...
      src = (fetchurl { url = "http://mawercer.de/~nix/reposhaxe_extlib_dev-cvs-F_14-41-03.tar.bz2"; sha256 = "1c6f28de716479535c71e4472a126b06005c754be91c0740cf45253898ad09ad"; });
    ...
    src_haxe_xml_light = { 
      ...
      src = (fetchurl { url = "http://mawercer.de/~nix/reposhaxe_xml_light-cvs-F_14-39-25.tar.bz2"; sha256 = "26179f74797f1b8760355578787359e2c6224d3d1ba53cb205336b35abd9ff63"; });
    ...
    src_haxe_neko_include = { 
      ...
      src = (fetchurl { url = "http://mawercer.de/~nix/reposhaxe_neko_include-cvs-F_14-40-21.tar.bz2"; sha256 = "5374a0a3a070a250c047905c95fcf326b7798544478790dda8604b03d7d094ea"; });
    ...
    src_haxe = {
      ...
      src = (fetchurl { url = "http://mawercer.de/~nix/reposhaxe-read-only-svn-3742.tar.bz2"; sha256 = "94174fe43dca35950c00ab9387e883813bc856646219259af83c80d679cb450f"; });
